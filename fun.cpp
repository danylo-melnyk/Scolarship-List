...
float getLowerBound(vector <Student>& students){
    return students.back().gpa;
}

void writeToCsv(const vector <Student>& students, float lowerBound){
    ofstream outFile;
    ...
    outFile << "Нижня межа отримання стипендії," << lowerBound << "\n";
